...
// These magic numbers and their coresponding table sizes were found with
...
// Attack tables
Bitboard pawnAttacks[128];
Bitboard knightAttacks[64];
Bitboard bishopAttacks[5009], * bishopPtr[64];
Bitboard rookAttacks[102359], * rookPtr[64];
